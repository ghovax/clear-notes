  ...
  return (
    <Card className="w-full max-w-full mx-auto">
      <CardHeader className="pb-2">
        <CardTitle className="text-base sm:text-lg">Process Transcription</CardTitle>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        >
          ...
          {file ? (
            ...
            <div>
              <p className="text-base sm:text-sm">Drag & drop a transcription file here, or tap to select</p>
